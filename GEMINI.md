...
The project uses GitHub Actions for CI/CD. The workflow in `.github/workflows/ci.yml` automatically runs linters and
builds Docker images on push and pull request events.
